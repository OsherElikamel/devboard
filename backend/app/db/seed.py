...
def seed():
    ...
    try:
        ...
        tasks_p1 = [
            ...
            ("Design login page", True, "medium"),
            ("Design dashboard page", True, "medium"),
            ("Build project cards component", True, "medium"),
            ("Add donut chart", True, "low"),
            ("Implement theme toggle", True, "low"),
            ...
            ("Add learning notes feature", False, "medium"),
            ("Add comments to tasks", False, "low"),
            ("Write backend tests", False, "high"),
            ("Add deployment info fields", False, "low"),
            ("Polish responsive layout", False, "medium"),
            ("Add skeleton loading states", False, "low"),
            ("Add error handling UI", False, "medium"),
            ("Prepare for deployment", False, "high"),
        ]
