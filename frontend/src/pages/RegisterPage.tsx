    ...
    <div className="min-h-screen flex items-center justify-center bg-dark-bg relative overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-md mx-4">
        ...
        <div className="rounded-2xl p-8 border border-white/[0.08] bg-dark-surface/80 backdrop-blur-xl shadow-[0_16px_40px_rgba(0,0,0,0.25)]">
          <h2 className="text-xl font-semibold text-white mb-1">Create your DevBoard account</h2>
          <p className="text-sm text-slate-500 mb-6">Start tracking your developer journey.</p>

          {error && <div className="mb-4 p-3 rounded-xl bg-danger/10 border border-danger/20 text-danger text-sm">{error}</div>}

          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <label className="block text-xs font-medium text-slate-400 mb-1.5 font-[family-name:var(--font-tech)] tracking-wide uppercase">Name</label>
            ...
            <div>
              <label className="block text-xs font-medium text-slate-400 mb-1.5 font-[family-name:var(--font-tech)] tracking-wide uppercase">Email</label>
              <div className="relative">
            ...
            <div>
              <label className="block text-xs font-medium text-slate-400 mb-1.5 font-[family-name:var(--font-tech)] tracking-wide uppercase">Password</label>
              <div className="relative">
            ...
            <div>
              <label className="block text-xs font-medium text-slate-400 mb-1.5 font-[family-name:var(--font-tech)] tracking-wide uppercase">Confirm Password</label>
              <div className="relative">
                <Lock size={16} className="absolute left-3 top-1/2 -translate-y-1/2 text-slate-500" />
